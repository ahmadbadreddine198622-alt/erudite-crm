...
const STAGE_LABELS = {
  ...
  mandate_negotiation: 'Mandate Negotiation',
  form_a_drafting: 'Form A Drafting',
  form_a_signature: 'Form A Signature',
  documents_collection: 'Documents Collection',
  marketing_live: 'Marketing Live',
  viewings_flow: 'Viewings Flow',
  offer_negotiation: 'Offer Negotiation',
  form_f_and_deposit: 'Form F & Deposit',
  closing: 'Closing',
