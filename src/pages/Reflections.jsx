...
import { GOLD, GOLD_LITE, pageWrap, card, goldStrip, serif, label, goldBtn, input, rankPill } from '@/lib/academyStyles';
...
export default function Reflections() {
  ...
  return (
    <div style={pageWrap}>
      <AcademyNav />
      <p style={{ ...label, color: GOLD }}>THE 17 · Module 04</p>
      <h1 style={{ ...serif, fontSize: 26, color: 'rgba(255,255,255,0.95)', margin: '2px 0 20px' }}>Reflections</h1>
