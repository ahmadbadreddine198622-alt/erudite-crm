...
const ALL_APPS = [
  { label: 'My Dashboard',      icon: UserCircle,     path: '/my-dashboard',       gradient: 'from-blue-900 to-blue-950',          shadow: 'shadow-blue-900/40' },
  { label: 'Pipeline',          icon: KanbanSquare,   path: '/pipeline',            gradient: 'from-violet-900 to-purple-950',       shadow: 'shadow-violet-900/40' },
  { label: 'Leads',             icon: Users,          path: '/leads',               gradient: 'from-emerald-800 to-emerald-950',     shadow: 'shadow-emerald-900/40', badgeKey: 'leads' },
  { label: 'Contacts',          icon: UserCheck,      path: '/contacts',            gradient: 'from-sky-900 to-cyan-950',            shadow: 'shadow-sky-900/40' },
  { label: 'Landlords',         icon: Building2,      path: '/landlords',           gradient: 'from-amber-900 to-orange-950',        shadow: 'shadow-amber-900/40' },
  { label: 'Projects',          icon: FolderOpen,     path: '/projects',            gradient: 'from-teal-900 to-teal-950',           shadow: 'shadow-teal-900/40' },
  { label: 'WhatsApp',          icon: MessageCircle,  path: '/whatsapp',            gradient: 'from-green-900 to-green-950',         shadow: 'shadow-green-900/40', badgeKey: 'whatsapp' },
  { label: 'Inbox',             icon: Inbox,          path: '/inbox',               gradient: 'from-blue-900 to-indigo-950',         shadow: 'shadow-indigo-900/40' },
  { label: 'Reminders',         icon: Bell,           path: '/reminders',           gradient: 'from-rose-900 to-red-950',            shadow: 'shadow-rose-900/40',  badgeKey: 'reminders' },
  { label: 'Analytics',         icon: BarChart3,      path: '/analytics',           gradient: 'from-purple-900 to-fuchsia-950',      shadow: 'shadow-purple-900/40' },
  { label: 'Sales Analytics',   icon: BarChart3,      path: '/sales-analytics',     gradient: 'from-pink-900 to-rose-950',           shadow: 'shadow-pink-900/40' },
  { label: 'Team',              icon: Users,          path: '/team',                gradient: 'from-slate-700 to-slate-900',         shadow: 'shadow-slate-700/40' },
  { label: 'Team AI OS',        icon: Brain,          path: '/team-os',             gradient: 'from-indigo-900 to-violet-950',       shadow: 'shadow-indigo-900/40' },
  { label: 'Team Performance',  icon: Trophy,         path: '/team-dashboard',      gradient: 'from-yellow-900 to-amber-950',        shadow: 'shadow-yellow-900/40' },
  { label: 'Offers',            icon: FileSignature,  path: '/offers',              gradient: 'from-cyan-900 to-blue-950',           shadow: 'shadow-cyan-900/40' },
  { label: 'Finance',           icon: Calculator,     path: '/finance',             gradient: 'from-green-900 to-teal-950',          shadow: 'shadow-green-900/40' },
  { label: 'Key Handover',      icon: Key,            path: '/key-handover',        gradient: 'from-orange-900 to-red-950',          shadow: 'shadow-orange-900/40' },
  { label: 'Commissions',       icon: DollarSign,     path: '/commissions',         gradient: 'from-amber-900 to-yellow-950',        shadow: 'shadow-amber-900/40' },
  { label: 'Map View',          icon: MapPin,         path: '/map',                 gradient: 'from-teal-900 to-cyan-950',           shadow: 'shadow-teal-900/40' },
  { label: 'WhatsApp Hub',      icon: Zap,            path: '/whatsapp-hub',        gradient: 'from-emerald-900 to-green-950',       shadow: 'shadow-emerald-900/40' },
  { label: 'Meta & Google',     icon: Zap,            path: '/meta-ads-leads',      gradient: 'from-blue-900 to-sky-950',            shadow: 'shadow-blue-900/40' },
  { label: 'Instagram Leads',   icon: Instagram,      path: '/instagram',           gradient: 'from-fuchsia-900 to-pink-950',        shadow: 'shadow-fuchsia-900/40' },
  { label: 'Property Finder',   icon: Link2,          path: '/property-finder',     gradient: 'from-red-900 to-rose-950',            shadow: 'shadow-red-900/40' },
  { label: 'Duplicate Detector',icon: GitMerge,       path: '/duplicates',          gradient: 'from-orange-900 to-amber-950',        shadow: 'shadow-orange-900/40' },
  { label: 'Email Automations', icon: Mail,           path: '/email-automations',   gradient: 'from-indigo-900 to-blue-950',         shadow: 'shadow-indigo-900/40' },
  { label: 'Claude AI',         icon: Sparkles,       path: '/claude-ai',           gradient: 'from-violet-900 to-purple-950',       shadow: 'shadow-violet-900/40' },
  { label: 'WhatsApp Setup',    icon: MessageCircle,  path: '/whatsapp-setup',      gradient: 'from-slate-800 to-slate-950',         shadow: 'shadow-slate-800/40' },
  { label: 'Form A Referral',   icon: Handshake,      path: '/form-a-referral',     gradient: 'from-amber-900 to-orange-950',        shadow: 'shadow-amber-900/40' },
  { label: 'Find Property',      icon: Search,         path: '/find-property',       gradient: 'from-cyan-900 to-teal-950',           shadow: 'shadow-cyan-900/40',  href: 'https://aiboostmarketing.com/lookup/?token=971581806000-4e32601555d5aa4902807dfe6c1368&sheetId=1Qu3xT9jrEW_xSVoRDk9cmeBGQVeMdyVId0LcN5v6NyE' },
  { label: 'DLD Lookup',         icon: Phone,          path: '/dld-lookup',          gradient: 'from-purple-900 to-fuchsia-950',      shadow: 'shadow-purple-900/40', href: 'https://aiboostmarketing.com/smart-bot/?user=971581806000-4e32601555d5aa4902807dfe6c1368&sheetId=1Qu3xT9jrEW_xSVoRDk9cmeBGQVeMdyVId0LcN5v6NyE' },
  { label: 'Transfer Numbers',    icon: Calculator,     path: '/transfer-breakdown',  gradient: 'from-green-900 to-emerald-950',       shadow: 'shadow-green-900/40',  href: 'https://claude.ai/project/019e7460-ea5f-74e0-8efb-c3a58527c3bd' },
  { label: 'Transfer Calculator', icon: Calculator,     path: '/transfer-calculator', gradient: 'from-amber-900 to-yellow-950',         shadow: 'shadow-amber-900/40' },
  { label: 'Form I Generator',     icon: FileSignature,  path: '/form-i-generator',    gradient: 'from-indigo-900 to-slate-950',         shadow: 'shadow-indigo-900/40' },
];
