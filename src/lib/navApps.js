...
import {
  ...
  TrendingUp, Activity, ShieldAlert, Globe, Shield, FileText, BookOpen, HardDrive,
  Target, Repeat, Eye, FileBox, Megaphone, Building, LineChart, UserSearch, CheckCircle, Camera, PhoneCall, ImageIcon, CalendarCheck, Send
} from 'lucide-react';

export const ALL_APPS = [
  { label: 'Pipeline',           icon: KanbanSquare,   path: '/pipeline',            gradient: 'from-indigo-500 to-purple-700',    glowColor: 'rgba(106,90,205,0.40)' },
  { label: 'Leads',              icon: Users,          path: '/leads',               gradient: 'from-emerald-400 to-teal-600',     glowColor: 'rgba(52,211,153,0.40)', badgeKey: 'leads' },
  { label: 'Contacts',           icon: UserCheck,      path: '/contacts',            gradient: 'from-sky-500 to-blue-700',         glowColor: 'rgba(14,165,233,0.40)' },
  { label: 'Landlords',          icon: Building2,      path: '/landlords',           gradient: 'from-amber-500 to-orange-700',     glowColor: 'rgba(245,158,11,0.40)' },
  { label: 'Closing',            icon: Handshake,      path: '/closing',             gradient: 'from-emerald-500 to-green-700',    glowColor: 'rgba(16,185,129,0.40)' },
  { label: 'Projects',           icon: FolderOpen,     path: '/projects',            gradient: 'from-teal-500 to-teal-700',        glowColor: 'rgba(20,184,166,0.40)' },
  { label: 'WhatsApp',           icon: MessageCircle,  path: '/whatsapp',            gradient: 'from-green-500 to-green-700',      glowColor: 'rgba(34,197,94,0.40)', badgeKey: 'whatsapp' },
  { label: 'Inbox',              icon: Inbox,          path: '/inbox',               gradient: 'from-blue-600 to-indigo-800',      glowColor: 'rgba(99,102,241,0.40)' },
  { label: 'Messages',           icon: MessageSquare,  path: '/messages',            gradient: 'from-green-500 to-emerald-700',    glowColor: 'rgba(16,185,129,0.40)' },
  ...
  { label: 'Analytics',          icon: BarChart3,      path: '/analytics',           gradient: 'from-orange-500 to-red-700',       glowColor: 'rgba(249,115,22,0.40)' },
  ...
  { label: 'Team AI OS',         icon: Brain,          path: '/team-os',             gradient: 'from-purple-500 to-pink-700',      glowColor: 'rgba(168,85,247,0.40)' },
  { label: 'Team Performance',   icon: Trophy,         path: '/team-dashboard',      gradient: 'from-yellow-500 to-amber-600',     glowColor: 'rgba(234,179,8,0.40)' },
  { label: 'Agent Intelligence', icon: Brain,          path: '/agent-intelligence',  gradient: 'from-purple-500 to-purple-700',   glowColor: 'rgba(139,92,246,0.40)' },
  { label: 'Offers',             icon: FileSignature,  path: '/offers',              gradient: 'from-cyan-500 to-blue-700',        glowColor: 'rgba(6,182,212,0.40)' },
  { label: 'Finance',            icon: Calculator,     path: '/finance',             gradient: 'from-blue-600 to-indigo-800',      glowColor: 'rgba(59,130,246,0.40)' },
  { label: 'Key Handover',       icon: Key,            path: '/key-handover',        gradient: 'from-orange-500 to-red-700',       glowColor: 'rgba(249,115,22,0.40)' },
  { label: 'Commissions',        icon: DollarSign,     path: '/commissions',         gradient: 'from-amber-400 to-yellow-600',     glowColor: 'rgba(245,158,11,0.40)' },
  { label: 'Map View',           icon: MapPin,         path: '/map',                 gradient: 'from-teal-500 to-cyan-700',        glowColor: 'rgba(20,184,166,0.40)' },
  { label: 'WhatsApp Hub',       icon: Zap,            path: '/whatsapp-hub',        gradient: 'from-emerald-500 to-green-700',    glowColor: 'rgba(16,185,129,0.40)', agentHidden: true },
  { label: 'Meta & Google',      icon: Zap,            path: '/meta-ads-leads',      gradient: 'from-blue-500 to-sky-600',         glowColor: 'rgba(59,130,246,0.40)' },
  ...
  { label: 'Company Settings',   icon: Building2,      path: '/company-settings',    gradient: 'from-orange-500 to-red-600',            glowColor: 'rgba(249,115,22,0.40)' },
  ...
  { label: 'Telegram Settings', icon: Send,           path: '/telegram-settings',  gradient: 'from-sky-500 to-blue-700',               glowColor: 'rgba(14,165,233,0.40)' },
];
