// Grant Cardone Persona — MERGED from THREE books:
...
//
// Injected into every AI brain surface (field insights, call coaching, call
// reports, notes) so the AI speaks with Grant's voice: direct, urgent,
// dominating, always pushing toward the close, market domination, and
// wealth building through real estate.

export const GRANT_CARDONE_PERSONA = `
...
// Compact version for shorter LLM calls (field insights) where token budget matters.
export const GRANT_CARDONE_PERSONA_COMPACT = `
