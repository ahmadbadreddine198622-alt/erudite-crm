...
const FIELD_SETS = {
  initial_contact: [
    { key: 'phone', label: 'Phone', get: (l) => has(l.phone) || has(l.whatsapp) },
    { key: 'whatsapp', label: 'WhatsApp', get: (l) => has(l.whatsapp) || has(l.phone) },
    { key: 'email', label: 'Email', get: (l) => has(l.email) },
