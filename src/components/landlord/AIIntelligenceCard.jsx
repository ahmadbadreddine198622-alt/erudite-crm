...
export default function AIIntelligenceCard({ ai, analyzing, onReanalyse, collapsed, onToggle }) {
  ...
  return (
    <div style={css("flex:none; margin:0 16px 6px; border-radius:12px; border:1px solid hsl(38 92% 50% / 0.28); background:linear-gradient(180deg, hsl(38 92% 50% / 0.07), rgba(255,255,255,0.02)); overflow:hidden; animation: ld-rise 0.4s cubic-bezier(0.22,1,0.36,1) both;")}>
      ...
      {isCollapsed ? (
        <button onClick={onToggle} style={css("width:100%; display:flex; align-items:center; justify-content:center; gap:10px; padding:6px 12px; padding-left:30%; background:none; border:none; cursor:pointer; font-family:'Inter',sans-serif;")}>
