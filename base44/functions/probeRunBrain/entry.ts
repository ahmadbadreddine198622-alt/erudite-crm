...
Deno.serve(async (req) => {
  try {
    ...
    const BUYER_TARGETS = new Set(['buyerOrchestrator', 'forgeBuyerApproachDrafts', 'generateBuyerCallScript', 'buyerColdAutoOutreach']);
    ...
    const payload = target === 'forgeBuyerApproachDrafts' || target === 'generateBuyerCallScript'
