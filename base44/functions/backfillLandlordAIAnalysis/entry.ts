...
Deno.serve(async (req) => {
  ...
  for (const landlord of landlords) {
    // ── Tier routing ── cheap engagement signal (stage/rapport on record); only pay for an
    // inbound/activity existence check when neither already marks the lead engaged.
